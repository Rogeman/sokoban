...
function WinState:render()
    ...
    love.graphics.printf('YOU WIN!', 0, VIRTUAL_HEIGHT / 2 + 64, VIRTUAL_WIDTH, 'center')
    love.graphics.printf('Select character to play again', 0, VIRTUAL_HEIGHT / 2 + 64+20, VIRTUAL_WIDTH, 'center')
end